  ...
  <footer class="text-white text-center text-lg-start" style="background-color: #23242a;">
      ...
      <p style="color: rgba(254, 219, 178, 1)">Quai Antique</p>
    </div>
      <!--Grid row-->
      <div class="row mt-4">
        <!--Grid column-->
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0" style="text-align: center;">
          <h4 class="text-uppercase mb-4" style="color: rgba(254, 219, 178, 1)">Localisation</h4>
            <div class="mapouter"><div class="gmap_canvas"><iframe width="400" height="300" id="gmap_canvas" src="https://maps.google.com/maps?q=44%20rue%20du%20limousin%20narbonne&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><br></div></div>
        </div>
      </div>
